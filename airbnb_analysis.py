...
def datafr():
    df = pd.read_csv(r"I:\projects\airbnb\Airbnb.csv")
    return df
...
if select == "Home":
    ...
    image1 = Image.open("C:/Users/admin/Desktop/youtube project/Airbnb.png")
    st.image(image1)
...
if select == "Data Exploration":
    ...
    with tab2:
        ...
        def datafr():
            df_a = pd.read_csv(r"I:\projects\airbnb\Airbnb.csv")
